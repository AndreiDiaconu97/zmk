...
#define LEAD_INST(n)                                                                         \
    ...
    DEVICE_DT_INST_DEFINE(n, behavior_leader_key_init, NULL, NULL, &behavior_leader_key_config_##n, APPLICATION, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &behavior_leader_key_driver_api);
